...
const PostPaid = ({ data, postpaidRow, getPostpaidInput }: any) => {
  const [charge, setCharge] = useState("endBalance");
      ...
      <h5 className="py-2 text-muted-foreground text-sm">Дараа төлбөрт</h5>
        <RadioGroup defaultValue={charge} onValueChange={setCharge}>
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="endBalance" className="normal-case">Эцсийн.үлд</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="chargedAmt" id="chargedAmt" />
              <Label htmlFor="chargedAmt" className="normal-case">Төлөх дүн</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="custom" id="custom" />
              <Label htmlFor="custom" className="normal-case">Гараар оруулах</Label>
            </div>
          </RadioGroup>
    {
      charge == 'custom' &&
      <Input placeholder="Дүн оруулах" type="string" className="mt-2" id="customInput" defaultValue={0} onInput={(e)=>{formatNumber(e, false)}}/>
    }
